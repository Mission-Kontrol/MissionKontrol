...
RSpec.feature 'User Dashboard Side Navigation', type: :feature do
  xscenario 'navigating to users will redirect to users route' do
...
RSpec.feature 'User Dashboard Side Navigation', type: :feature do
  xscenario 'navigating to companies will redirect to companies route' do
    given_i_am_on_the_dashboard_page
...
RSpec.feature 'User Dashboard Side Navigation', type: :feature do
  xscenario 'navigating to reports  will redirect to reports route' do
    given_i_am_on_the_dashboard_page
